...
insert into products (id,pdf,created_at,
                      ...
                      sub_category_id)
values (1,'https://media.cnn.com/api/v1/images/stellar/prod/220920215114-iphone-14-lead.jpg?c=16x9&q=h_720,w_1280,c_fill/f_webp','2023-05-01','2023-01-01',
       ...
       (2,'https://media.cnn.com/api/v1/images/stellar/prod/220920215114-iphone-14-lead.jpg?c=16x9&q=h_720,w_1280,c_fill/f_webp','2023-05-01','2023-01-01',
       ...
       (4,'https://media.cnn.com/api/v1/images/stellar/prod/220920215923-iphone-14-design-1.jpg?c=16x9&q=h_720,w_1280,c_fill/f_webp','2023-03-29','2020-09-15',
       ...
       (5,'https://media.cnn.com/api/v1/images/stellar/prod/220920215155-iphone-14-display-1.jpg?c=16x9&q=h_720,w_1280,c_fill/f_webp','2022-12-11','2022-01-01',
       ...
       (6,'https://www.apple.com/newsroom/images/product/iphone/standard/Apple-iPhone-14-Pro-iPhone-14-Pro-Max-hero-220907_Full-Bleed-Image.jpg.xlarge_2x.jpg','2023-03-19','2023-03-13',
...
values (1,'dark purple',134990,6,'12345',1,2),
       (2,'silver',140900,10,'21345',1,2),
       (3,'dark green',119900,13,'31245',2,3),
       (4,'beige',119900,19,'41235',2,5),

       (5,'onyx gray',274800.99,20,'51234',3,4),

       (6,'silver',63990.99,17,'54321',4,1),
       (7,'rose gold',69800.99,8,'45321',4,4),

       (8,'pearl white',31980.90,40,'35421',5,5),
...
values (1,'Добрый день! Благодарим Вас....','Быстрая доставка на этом все хорошее кончается.
Купил роутер Xiaomi Mi Wi-Fi Router mini, который отказался работать с моим телефоном. В возврате отказали.',
        5,2,2),
       (2,'answer','Вместо колонки JBL Charge 4 мне прислали хлипкую колонку за 299 рублей из Китая! Никому не порекомендовал бы покупать (а уж тем более, заказывать) с неизвестных сайтов тупые китайские подделки на дорогостоящие товары-гаджеты. ',
        2,2,2),
       (3,null,'Купила внешний аккумулятор Xiaomi и чехольчики к нему, доставили в этот же день и еще с подарочком (USB-лампа), приятно!!! А еще хочу отметить стильный удобный сайт :) Влюбилась в одну экшн-камеру... если буду покупать, то только здесь :) Спасибо!',
        5,2,3),
       (4,null,'Покупал всего один раз, но впечатление отличное. Товар оригинальный, продавец приятный и в теме.
А самое главное предоставляет чек и гарантию, которую ни на али, ни на авито не получить. Рекомендую.',
        4,2,2),
